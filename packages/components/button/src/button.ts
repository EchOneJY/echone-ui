...
export const buttonVariants = cva(
  'cursor-pointer inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:(outline-none ring-1 ring-ring) disabled:(pointer-events-none cursor-not-allowed opacity-50)',
  {
    defaultVariants: {
      size: 'default',
      variant: 'default',
